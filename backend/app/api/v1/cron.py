...
async def cron_discover_remote(authorization: str | None = Header(None)):
    ...
    # WeWorkRemotely is intentionally excluded — their posting pages now
    # sit behind a notification-paywall UX that makes the apply link
    # unreachable on the free tier. Re-enable if they roll that back.
